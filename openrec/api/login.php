<?php
	...
	// 	$secret = "6Lc902wUAAAAACpLkPnTAUoYfORC6kawix7mwnki";
	...
	// 					session_start();
	// 					$_SESSION['nrp'] = $user;
	// 					$result['redirect'] = "/lkmmtm22/openrec/home.html";
	// 					$result['status'] = 1;	
	// 					$result['error'] = 'Login Success!';
	// 					header("Location: ../home.html");
				
	// 				}else{
	// 					$result['redirect'] = "/lkmmtm22/openrec/login.html";
	// 					$result['status'] = 2;	
